...
public class TelaUsuario extends javax.swing.JFrame {
    ...
    private int idUsuarioLogado = 6; // ID padrão para teste
    ...
    public void excluir() {
        ...
        String sqlTopico = "DELETE FROM t_topico WHERE t_usuario_id_usuario=?";
        ...
        if (confirma == javax.swing.JOptionPane.YES_OPTION) {
            try {
                ...
                pst = con.prepareStatement(sqlTopico);
                pst.setInt(6, idUsuarioLogado);
                pst.executeUpdate();
                pst.close();
